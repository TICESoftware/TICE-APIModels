public struct CreateGroupRequest: Codable {
    ...
    public init(groupId: String, type: GroupType, joinMode: JoinMode, permissionMode: PermissionMode, selfSignedAdminCertificate: Membership, encryptedSettings: String, encryptedInternalSettings: String, parent: Parent?) {
