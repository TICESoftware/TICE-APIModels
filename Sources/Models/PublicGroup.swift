...
public struct PublicGroup {
    ...
    public init(groupId: GroupId, type: GroupType, parentGroupId: GroupId?, groupKey: String, joinMode: JoinMode, permissionMode: PermissionMode, url: URL, groupSettings: GroupSettings, tag: GroupTag) {
